...
def setup():
    try:
        ...
        pass
    key = "extra-keys = [['ESC','/','-','PYTHON','UP','END','PGUP'],['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN']]"
...
if __name__=='__main__':
    ...
    while t.is_alive():
        for i in "-\|/-\|/":
            ...
            sleep(0.1)
    banner()
    print(c+'Silahkan hubungi '087827348594' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
